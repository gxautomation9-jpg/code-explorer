...
export function pickBestVoice(
  ...
  if (!matching.length) return undefined; // no language match → caller falls back to lang-only utterance
  return [...matching].sort((a, b) => score(b, prefs.preferFemale) - score(a, prefs.preferFemale))[0];
}
